...
# TODO：exp_dir
exp_dir = r""
model_dir = exp_dir + r"./SingleNet/MobileNetV2.pk"  # ['ResNet18.pk', MobileNetV2.pk']
...
for im in os.listdir(img_dir):
    ...
    print("Estimated PM2.5: ", pred_nor.cpu().numpy())
    all_pred = np.vstack((all_pred, pred_nor.cpu().numpy()))
